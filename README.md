...
## TTG – 3D Printer Status → WLED Status LEDs (v1)
...
## TTG – 4Led  → Indicator (v1)

Controls a 4 Led WLED light based on a sensor 
(Voltage, Wind Speed Progress etc.).

### Install
1. In Home Assistant, go to **Settings → Automations & Scenes → Blueprints**
2. Click **Import Blueprint**
3. Paste this URL: https://raw.githubusercontent.com/TechTimeGuy/HomeAssistant_Blueprints/refs/heads/main/blueprints/automation/techtimeguy/ttg_4led_indicator_v1.yaml
4. Click **Preview Blueprint**
5. Click **Import Blueprint**
6. Create a new automation using the blueprint
